...
public class ClienteDAO {
    ...
    public static void main(String[] args) {
        try {
            ...
            c1.setPrimerNombre("Eliab");
            c1.setSegundoNombre("Javier");
            c1.setPrimerApellido("Selva");
            c1.setSegundoApellido("Cruz");
            c1.setCelular("77330714");
            c1.setDireccion("Por la Gaviota");
            c1.setCedula("1213008970004Y");
            dao.crearCliente(c1);
